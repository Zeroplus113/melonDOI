...
include '../../connectDB.php';
    ...
    $sql2 = "INSERT INTO biopesticide(amount,bio_typeID,periodID,greenhouseID) VALUES(20,1,'$periodID','$greenhouseID')";
    $con->query($sql2);
    ...
    $sql3 = "SELECT greenhouseID,periodID FROM biopesticide WHERE greenhouseID = '$greenhouseID' AND periodID = '$periodID' ";
    ...
    if($count_row2!=0){
        while($rs2 = $result2->fetch_assoc()){
            ...
            header("location:../../dailycare/bio.php");
            }
        }
    }
