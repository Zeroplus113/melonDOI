...
include '../../connectDB.php';
    ...
    $sql2 = "INSERT INTO pest(periodID,greenhouseID) VALUES('$periodID','$greenhouseID')";
    $con->query($sql2);
    ...
    $sql3 = "SELECT greenhouseID,periodID FROM pest WHERE greenhouseID = '$greenhouseID' AND periodID = '$periodID' ";
    ...
    if($count_row2!=0){
        while($rs2 = $result2->fetch_assoc()){
            ...
            header("location:../../dailycare/pest.php");
            }
        }
    }
